...
function HeadingLink(_a) {
  ...
  return /* @__PURE__ */ jsxs(Tag, __spreadProps(__spreadValues({ className: `subheading-${Tag}` }, props), { children: [
    children,
    /* @__PURE__ */ jsx("span", { className: "nx-absolute -nx-mt-7", id }),
    /* @__PURE__ */ jsx(
      "a",
      {
        href: id && `#${id}`,
...
var A = (_a) => {
  ...
  if (isExternal) {
    return /* @__PURE__ */ jsxs("a", __spreadProps(__spreadValues({ target: "_blank", rel: "noreferrer" }, props), { children: [
      children,
      /* @__PURE__ */ jsx("span", { className: "nx-sr-only nx-select-none", children: " (opens in a new tab)" })
    ] }));
  }
  return props.href ? /* @__PURE__ */ jsx(Link, { href: props.href, passHref: true, legacyBehavior: true, children: /* @__PURE__ */ jsx("a", __spreadProps(__spreadValues({}, props), { children })) }) : null;
};
var useComponents = () => {
